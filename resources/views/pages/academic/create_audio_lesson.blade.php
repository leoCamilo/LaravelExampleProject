@extends('components.app', [ 'sidemenu' => ['side24' => 'true'], 'navbar' => []])
@section('content')
		...
		<div class="col-md-10 offset-md-1">
			<div class="card">
				<div class="card-header card-header-warning card-header-icon">
					...
					<h4 class="card-title">Adicionar Áudio Aula</h4>
				</div>

				<div class="card-body">
					<form action="/audiolessons" method="POST">
						{!! csrf_field() !!}
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group has-warning">
									<label class="bmd-label-floating">soundcloud link (ex: &#60;iframe src=https://w.soundcloud.com/player/?url=https%3A...)</label>
